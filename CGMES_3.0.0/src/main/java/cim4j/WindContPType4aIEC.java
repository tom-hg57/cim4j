...
public class WindContPType4aIEC extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindContPType4aIEC().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("WindTurbineType4aIEC", "http://iec.ch/TC57/CIM100#"),
            Map.entry("dpmaxp4a", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpordp4a", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tufiltp4a", "http://iec.ch/TC57/CIM100#"),
