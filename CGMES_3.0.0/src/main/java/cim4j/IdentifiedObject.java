...
public class IdentifiedObject extends BaseClass {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("DiagramObjects", "http://iec.ch/TC57/CIM100#"),
            Map.entry("description", "http://iec.ch/TC57/CIM100#"),
            Map.entry("energyIdentCodeEic", "http://iec.ch/TC57/CIM100-European#"),
            Map.entry("mRID", "http://iec.ch/TC57/CIM100#"),
            Map.entry("name", "http://iec.ch/TC57/CIM100#"),
            Map.entry("shortName", "http://iec.ch/TC57/CIM100-European#"),
