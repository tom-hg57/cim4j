...
public class ExcST6B extends ExcitationSystemDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("ilr", "http://iec.ch/TC57/CIM100#"),
            Map.entry("k1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kcl", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kff", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kg", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kia", "http://iec.ch/TC57/CIM100#"),
            Map.entry("klr", "http://iec.ch/TC57/CIM100#"),
            Map.entry("km", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kpa", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kvd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("oelin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tg", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tvd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vamax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vamin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vilim", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vimax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vimin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vmult", "http://iec.ch/TC57/CIM100#"),
