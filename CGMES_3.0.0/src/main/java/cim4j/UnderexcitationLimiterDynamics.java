...
public class UnderexcitationLimiterDynamics extends DynamicsFunctionBlock {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new UnderexcitationLimiterDynamics().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(UnderexcitationLimiterDynamics_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(UnderexcitationLimiterDynamics_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated UnderexcitationLimiterDynamics, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated UnderexcitationLimiterDynamics, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            UnderexcitationLimiterDynamics_primitive_builder attrEnum = UnderexcitationLimiterDynamics_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = UnderexcitationLimiterDynamics_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            UnderexcitationLimiterDynamics_class_attributes_enum attrEnum = UnderexcitationLimiterDynamics_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = UnderexcitationLimiterDynamics_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : UnderexcitationLimiterDynamics_primitive_builder.values()) {
            if (enumValue != UnderexcitationLimiterDynamics_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "UnderexcitationLimiterDynamics." + enumValue.name());
            }
        }
        for (var enumValue : UnderexcitationLimiterDynamics_class_attributes_enum.values()) {
            if (enumValue != UnderexcitationLimiterDynamics_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "UnderexcitationLimiterDynamics." + enumValue.name());
            }
        }
    ...
    static {
        ATTR_NAMESPACE_MAP = new UnderexcitationLimiterDynamics().allAttrNamespaceMap();
    }
