...
public class TapChanger extends PowerSystemResource {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("SvTapStep", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TapChangerControl", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TapSchedules", "http://iec.ch/TC57/CIM100#"),
            Map.entry("controlEnabled", "http://iec.ch/TC57/CIM100#"),
            Map.entry("highStep", "http://iec.ch/TC57/CIM100#"),
            Map.entry("lowStep", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ltcFlag", "http://iec.ch/TC57/CIM100#"),
            Map.entry("neutralStep", "http://iec.ch/TC57/CIM100#"),
            Map.entry("neutralU", "http://iec.ch/TC57/CIM100#"),
            Map.entry("normalStep", "http://iec.ch/TC57/CIM100#"),
            Map.entry("step", "http://iec.ch/TC57/CIM100#"),
