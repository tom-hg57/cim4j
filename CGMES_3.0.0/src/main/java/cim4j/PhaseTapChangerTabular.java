...
public class PhaseTapChangerTabular extends PhaseTapChanger {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new PhaseTapChangerTabular().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(PhaseTapChangerTabular_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(PhaseTapChangerTabular_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated PhaseTapChangerTabular, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated PhaseTapChangerTabular, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            PhaseTapChangerTabular_primitive_builder attrEnum = PhaseTapChangerTabular_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PhaseTapChangerTabular_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            PhaseTapChangerTabular_class_attributes_enum attrEnum = PhaseTapChangerTabular_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PhaseTapChangerTabular_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : PhaseTapChangerTabular_primitive_builder.values()) {
            if (enumValue != PhaseTapChangerTabular_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PhaseTapChangerTabular." + enumValue.name());
            }
        }
        for (var enumValue : PhaseTapChangerTabular_class_attributes_enum.values()) {
            if (enumValue != PhaseTapChangerTabular_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PhaseTapChangerTabular." + enumValue.name());
            }
        }
    ...
    static {
        ATTR_NAMESPACE_MAP = new PhaseTapChangerTabular().allAttrNamespaceMap();
    }
