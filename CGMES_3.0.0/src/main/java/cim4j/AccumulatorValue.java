...
public class AccumulatorValue extends MeasurementValue {
    ...
    static {
        ATTR_NAMESPACE_MAP = new AccumulatorValue().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("Accumulator", "http://iec.ch/TC57/CIM100#"),
            Map.entry("AccumulatorReset", "http://iec.ch/TC57/CIM100#"),
