...
public class Diagram extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new Diagram().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("DiagramElements", "http://iec.ch/TC57/CIM100#"),
            Map.entry("DiagramStyle", "http://iec.ch/TC57/CIM100#"),
            Map.entry("orientation", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x1InitialView", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x2InitialView", "http://iec.ch/TC57/CIM100#"),
            Map.entry("y1InitialView", "http://iec.ch/TC57/CIM100#"),
            Map.entry("y2InitialView", "http://iec.ch/TC57/CIM100#"),
