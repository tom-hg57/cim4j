...
public class WindContPType4bIEC extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindContPType4bIEC().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("WindTurbineType4bIEC", "http://iec.ch/TC57/CIM100#"),
            Map.entry("dpmaxp4b", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpaero", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpordp4b", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tufiltp4b", "http://iec.ch/TC57/CIM100#"),
