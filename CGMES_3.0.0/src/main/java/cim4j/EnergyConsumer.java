...
public class EnergyConsumer extends EnergyConnection {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("LoadDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("LoadResponse", "http://iec.ch/TC57/CIM100#"),
            Map.entry("p", "http://iec.ch/TC57/CIM100#"),
            Map.entry("pfixed", "http://iec.ch/TC57/CIM100#"),
            Map.entry("pfixedPct", "http://iec.ch/TC57/CIM100#"),
            Map.entry("q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("qfixed", "http://iec.ch/TC57/CIM100#"),
            Map.entry("qfixedPct", "http://iec.ch/TC57/CIM100#"),
