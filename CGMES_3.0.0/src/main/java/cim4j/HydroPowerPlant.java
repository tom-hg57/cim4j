...
public class HydroPowerPlant extends PowerSystemResource {
    ...
    static {
        ATTR_NAMESPACE_MAP = new HydroPowerPlant().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("HydroGeneratingUnits", "http://iec.ch/TC57/CIM100#"),
            Map.entry("HydroPumps", "http://iec.ch/TC57/CIM100#"),
            Map.entry("hydroPlantStorageType", "http://iec.ch/TC57/CIM100#"),
