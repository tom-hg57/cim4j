...
public class GovGAST3 extends TurbineGovernorDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("bca", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("dtc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ka", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kac", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kca", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ksi", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ky", "http://iec.ch/TC57/CIM100#"),
            Map.entry("mnef", "http://iec.ch/TC57/CIM100#"),
            Map.entry("mxef", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rcmn", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rcmx", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tac", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("td", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tfen", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tg", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tsi", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tt", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ttc", "http://iec.ch/TC57/CIM100#"),
