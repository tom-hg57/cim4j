...
public class ACDCTerminal extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ACDCTerminal().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("BusNameMarker", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Measurements", "http://iec.ch/TC57/CIM100#"),
            Map.entry("OperationalLimitSet", "http://iec.ch/TC57/CIM100#"),
            Map.entry("connected", "http://iec.ch/TC57/CIM100#"),
            Map.entry("sequenceNumber", "http://iec.ch/TC57/CIM100#"),
