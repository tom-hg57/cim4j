...
public class PFVArType2IEEEPFController extends PFVArControllerType2Dynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new PFVArType2IEEEPFController().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("exlon", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ki", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("pfref", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vclmt", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vref", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vs", "http://iec.ch/TC57/CIM100#"),
