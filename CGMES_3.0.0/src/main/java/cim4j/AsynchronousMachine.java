...
public class AsynchronousMachine extends RotatingMachine {
    ...
    static {
        ATTR_NAMESPACE_MAP = new AsynchronousMachine().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("asynchronousMachineType", "http://iec.ch/TC57/CIM100#"),
            Map.entry("converterFedDrive", "http://iec.ch/TC57/CIM100#"),
            Map.entry("efficiency", "http://iec.ch/TC57/CIM100#"),
            Map.entry("iaIrRatio", "http://iec.ch/TC57/CIM100#"),
            Map.entry("nominalFrequency", "http://iec.ch/TC57/CIM100#"),
            Map.entry("nominalSpeed", "http://iec.ch/TC57/CIM100#"),
            Map.entry("polePairNumber", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ratedMechanicalPower", "http://iec.ch/TC57/CIM100#"),
            Map.entry("reversible", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rxLockedRotorRatio", "http://iec.ch/TC57/CIM100#"),
