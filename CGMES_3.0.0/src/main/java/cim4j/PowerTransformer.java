...
public class PowerTransformer extends ConductingEquipment {
    ...
    static {
        ATTR_NAMESPACE_MAP = new PowerTransformer().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("PowerTransformerEnd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("beforeShCircuitHighestOperatingCurrent", "http://iec.ch/TC57/CIM100#"),
            Map.entry("beforeShCircuitHighestOperatingVoltage", "http://iec.ch/TC57/CIM100#"),
            Map.entry("beforeShortCircuitAnglePf", "http://iec.ch/TC57/CIM100#"),
            Map.entry("highSideMinOperatingU", "http://iec.ch/TC57/CIM100#"),
            Map.entry("isPartOfGeneratorUnit", "http://iec.ch/TC57/CIM100#"),
            Map.entry("operationalValuesConsidered", "http://iec.ch/TC57/CIM100#"),
