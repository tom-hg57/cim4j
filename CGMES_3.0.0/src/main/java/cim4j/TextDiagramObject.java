...
public class TextDiagramObject extends DiagramObject {
    ...
    private static final Logging LOG = Logging.getLogger(TextDiagramObject.class);
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new TextDiagramObject().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(TextDiagramObject_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(TextDiagramObject_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated TextDiagramObject, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated TextDiagramObject, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            TextDiagramObject_primitive_builder attrEnum = TextDiagramObject_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = TextDiagramObject_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            TextDiagramObject_class_attributes_enum attrEnum = TextDiagramObject_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = TextDiagramObject_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : TextDiagramObject_primitive_builder.values()) {
            if (enumValue != TextDiagramObject_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "TextDiagramObject." + enumValue.name());
            }
        }
        for (var enumValue : TextDiagramObject_class_attributes_enum.values()) {
            if (enumValue != TextDiagramObject_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "TextDiagramObject." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "TextDiagramObject";
    ...
    static {
        ATTR_NAMESPACE_MAP = new TextDiagramObject().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("text", "http://iec.ch/TC57/CIM100#"),
