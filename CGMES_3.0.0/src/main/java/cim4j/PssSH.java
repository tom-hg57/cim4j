...
public class PssSH extends PowerSystemStabilizerDynamics {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new PssSH().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(PssSH_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(PssSH_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated PssSH, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated PssSH, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            PssSH_primitive_builder attrEnum = PssSH_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PssSH_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            PssSH_class_attributes_enum attrEnum = PssSH_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PssSH_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : PssSH_primitive_builder.values()) {
            if (enumValue != PssSH_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PssSH." + enumValue.name());
            }
        }
        for (var enumValue : PssSH_class_attributes_enum.values()) {
            if (enumValue != PssSH_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PssSH." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "PssSH";
    ...
    static {
        ATTR_NAMESPACE_MAP = new PssSH().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("k0", "http://iec.ch/TC57/CIM100#"),
            ...
            Map.entry("vsmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vsmin", "http://iec.ch/TC57/CIM100#"),
