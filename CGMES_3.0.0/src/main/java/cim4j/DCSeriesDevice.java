...
public class DCSeriesDevice extends DCConductingEquipment {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : DCSeriesDevice_primitive_builder.values()) {
            if (enumValue != DCSeriesDevice_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "DCSeriesDevice." + enumValue.name());
            }
        }
        for (var enumValue : DCSeriesDevice_class_attributes_enum.values()) {
            if (enumValue != DCSeriesDevice_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "DCSeriesDevice." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "DCSeriesDevice";
    ...
    static {
        ATTR_NAMESPACE_MAP = new DCSeriesDevice().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("inductance", "http://iec.ch/TC57/CIM100#"),
            Map.entry("resistance", "http://iec.ch/TC57/CIM100#"),
