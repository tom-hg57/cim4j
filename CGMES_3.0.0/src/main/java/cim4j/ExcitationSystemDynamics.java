...
public class ExcitationSystemDynamics extends DynamicsFunctionBlock {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ExcitationSystemDynamics().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("DiscontinuousExcitationControlDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("OverexcitationLimiterDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PFVArControllerType1Dynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PFVArControllerType2Dynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PowerSystemStabilizerDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SynchronousMachineDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("UnderexcitationLimiterDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("VoltageCompensatorDynamics", "http://iec.ch/TC57/CIM100#"),
