...
public class GovHydroIEEE0 extends TurbineGovernorDynamics {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new GovHydroIEEE0().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(GovHydroIEEE0_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(GovHydroIEEE0_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated GovHydroIEEE0, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated GovHydroIEEE0, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            GovHydroIEEE0_primitive_builder attrEnum = GovHydroIEEE0_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = GovHydroIEEE0_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            GovHydroIEEE0_class_attributes_enum attrEnum = GovHydroIEEE0_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = GovHydroIEEE0_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : GovHydroIEEE0_primitive_builder.values()) {
            if (enumValue != GovHydroIEEE0_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "GovHydroIEEE0." + enumValue.name());
            }
        }
        for (var enumValue : GovHydroIEEE0_class_attributes_enum.values()) {
            if (enumValue != GovHydroIEEE0_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "GovHydroIEEE0." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "GovHydroIEEE0";
    ...
    static {
        ATTR_NAMESPACE_MAP = new GovHydroIEEE0().allAttrNamespaceMap();
    }
