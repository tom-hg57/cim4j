...
public class Terminal extends ACDCTerminal {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("AuxiliaryEquipment", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ConductingEquipment", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ConnectivityNode", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ConverterDCSides", "http://iec.ch/TC57/CIM100#"),
            Map.entry("HasFirstMutualCoupling", "http://iec.ch/TC57/CIM100#"),
            Map.entry("HasSecondMutualCoupling", "http://iec.ch/TC57/CIM100#"),
            Map.entry("RegulatingControl", "http://iec.ch/TC57/CIM100#"),
            Map.entry("RemoteInputSignal", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SvPowerFlow", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TieFlow", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TopologicalNode", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TransformerEnd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("phases", "http://iec.ch/TC57/CIM100#"),
