...
public class CurveData extends BaseClass {
    ...
    static {
        ATTR_NAMESPACE_MAP = new CurveData().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("Curve", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xvalue", "http://iec.ch/TC57/CIM100#"),
            Map.entry("y1value", "http://iec.ch/TC57/CIM100#"),
            Map.entry("y2value", "http://iec.ch/TC57/CIM100#"),
