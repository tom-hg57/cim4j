...
public class TapChangerControl extends RegulatingControl {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new TapChangerControl().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(TapChangerControl_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(TapChangerControl_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated TapChangerControl, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated TapChangerControl, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            TapChangerControl_primitive_builder attrEnum = TapChangerControl_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = TapChangerControl_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            TapChangerControl_class_attributes_enum attrEnum = TapChangerControl_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = TapChangerControl_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : TapChangerControl_primitive_builder.values()) {
            if (enumValue != TapChangerControl_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "TapChangerControl." + enumValue.name());
            }
        }
        for (var enumValue : TapChangerControl_class_attributes_enum.values()) {
            if (enumValue != TapChangerControl_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "TapChangerControl." + enumValue.name());
            }
        }
    ...
    static {
        ATTR_NAMESPACE_MAP = new TapChangerControl().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("TapChanger", "http://iec.ch/TC57/CIM100#"),
