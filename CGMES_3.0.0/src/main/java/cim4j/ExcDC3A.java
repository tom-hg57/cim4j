...
public class ExcDC3A extends ExcitationSystemDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ExcDC3A().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("efd1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("efd2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("efdlim", "http://iec.ch/TC57/CIM100#"),
            ...
            Map.entry("kv", "http://iec.ch/TC57/CIM100#"),
            Map.entry("seefd1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("seefd2", "http://iec.ch/TC57/CIM100#"),
