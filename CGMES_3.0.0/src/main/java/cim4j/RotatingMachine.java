...
public class RotatingMachine extends RegulatingCondEq {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new RotatingMachine().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(RotatingMachine_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(RotatingMachine_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated RotatingMachine, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated RotatingMachine, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            RotatingMachine_primitive_builder attrEnum = RotatingMachine_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = RotatingMachine_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            RotatingMachine_class_attributes_enum attrEnum = RotatingMachine_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = RotatingMachine_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : RotatingMachine_primitive_builder.values()) {
            if (enumValue != RotatingMachine_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "RotatingMachine." + enumValue.name());
            }
        }
        for (var enumValue : RotatingMachine_class_attributes_enum.values()) {
            if (enumValue != RotatingMachine_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "RotatingMachine." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "RotatingMachine";
    ...
    static {
        ATTR_NAMESPACE_MAP = new RotatingMachine().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("GeneratingUnit", "http://iec.ch/TC57/CIM100#"),
            Map.entry("HydroPump", "http://iec.ch/TC57/CIM100#"),
            Map.entry("p", "http://iec.ch/TC57/CIM100#"),
            Map.entry("q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ratedPowerFactor", "http://iec.ch/TC57/CIM100#"),
