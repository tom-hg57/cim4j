...
public class ExcELIN1 extends ExcitationSystemDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ExcELIN1().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("dpnf", "http://iec.ch/TC57/CIM100#"),
            Map.entry("efmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("efmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ks1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ks2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("smax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tfi", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tnu", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tsw", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vpi", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vpnf", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vpu", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xe", "http://iec.ch/TC57/CIM100#"),
