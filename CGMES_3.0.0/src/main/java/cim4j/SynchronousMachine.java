...
public class SynchronousMachine extends RotatingMachine {
    ...
    static {
        ATTR_NAMESPACE_MAP = new SynchronousMachine().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("InitialReactiveCapabilityCurve", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SynchronousMachineDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("earthing", "http://iec.ch/TC57/CIM100#"),
            Map.entry("earthingStarPointR", "http://iec.ch/TC57/CIM100#"),
            Map.entry("earthingStarPointX", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ikk", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maxQ", "http://iec.ch/TC57/CIM100#"),
            Map.entry("minQ", "http://iec.ch/TC57/CIM100#"),
            Map.entry("mu", "http://iec.ch/TC57/CIM100#"),
            Map.entry("operatingMode", "http://iec.ch/TC57/CIM100#"),
            Map.entry("qPercent", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r0", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("referencePriority", "http://iec.ch/TC57/CIM100#"),
            Map.entry("satDirectSubtransX", "http://iec.ch/TC57/CIM100#"),
            Map.entry("satDirectSyncX", "http://iec.ch/TC57/CIM100#"),
            Map.entry("satDirectTransX", "http://iec.ch/TC57/CIM100#"),
            Map.entry("shortCircuitRotorType", "http://iec.ch/TC57/CIM100#"),
            Map.entry("type", "http://iec.ch/TC57/CIM100#"),
            Map.entry("voltageRegulationRange", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x0", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x2", "http://iec.ch/TC57/CIM100#"),
