...
public class ExcAVR4 extends ExcitationSystemDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ExcAVR4().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("imul", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ka", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ke", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kif", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t1if", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t4", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tif", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vfmn", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vfmx", "http://iec.ch/TC57/CIM100#"),
