...
public class PhaseTapChangerTablePoint extends TapChangerTablePoint {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new PhaseTapChangerTablePoint().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(PhaseTapChangerTablePoint_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(PhaseTapChangerTablePoint_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated PhaseTapChangerTablePoint, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated PhaseTapChangerTablePoint, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            PhaseTapChangerTablePoint_primitive_builder attrEnum = PhaseTapChangerTablePoint_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PhaseTapChangerTablePoint_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            PhaseTapChangerTablePoint_class_attributes_enum attrEnum = PhaseTapChangerTablePoint_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PhaseTapChangerTablePoint_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : PhaseTapChangerTablePoint_primitive_builder.values()) {
            if (enumValue != PhaseTapChangerTablePoint_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PhaseTapChangerTablePoint." + enumValue.name());
            }
        }
        for (var enumValue : PhaseTapChangerTablePoint_class_attributes_enum.values()) {
            if (enumValue != PhaseTapChangerTablePoint_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PhaseTapChangerTablePoint." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "PhaseTapChangerTablePoint";
    ...
    static {
        ATTR_NAMESPACE_MAP = new PhaseTapChangerTablePoint().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("PhaseTapChangerTable", "http://iec.ch/TC57/CIM100#"),
            Map.entry("angle", "http://iec.ch/TC57/CIM100#"),
