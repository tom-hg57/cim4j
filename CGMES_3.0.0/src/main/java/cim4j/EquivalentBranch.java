...
public class EquivalentBranch extends EquivalentEquipment {
    ...
    static {
        ATTR_NAMESPACE_MAP = new EquivalentBranch().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("negativeR12", "http://iec.ch/TC57/CIM100#"),
            Map.entry("negativeR21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("negativeX12", "http://iec.ch/TC57/CIM100#"),
            Map.entry("negativeX21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("positiveR12", "http://iec.ch/TC57/CIM100#"),
            Map.entry("positiveR21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("positiveX12", "http://iec.ch/TC57/CIM100#"),
            Map.entry("positiveX21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("zeroR12", "http://iec.ch/TC57/CIM100#"),
            Map.entry("zeroR21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("zeroX12", "http://iec.ch/TC57/CIM100#"),
            Map.entry("zeroX21", "http://iec.ch/TC57/CIM100#"),
