...
public class LinearShuntCompensator extends ShuntCompensator {
    ...
    static {
        ATTR_NAMESPACE_MAP = new LinearShuntCompensator().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("b0PerSection", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bPerSection", "http://iec.ch/TC57/CIM100#"),
            Map.entry("g0PerSection", "http://iec.ch/TC57/CIM100#"),
            Map.entry("gPerSection", "http://iec.ch/TC57/CIM100#"),
