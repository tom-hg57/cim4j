...
public class DiscExcContIEEEDEC1A extends DiscontinuousExcitationControlDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("esc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kan", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ketl", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tan", "http://iec.ch/TC57/CIM100#"),
            Map.entry("td", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tl1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tl2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tw5", "http://iec.ch/TC57/CIM100#"),
            Map.entry("val", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vanmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vomax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vomin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vsmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vsmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vtc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vtlmt", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vtm", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vtn", "http://iec.ch/TC57/CIM100#"),
