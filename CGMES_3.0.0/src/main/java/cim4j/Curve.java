...
public class Curve extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new Curve().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("CurveDatas", "http://iec.ch/TC57/CIM100#"),
            Map.entry("curveStyle", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xUnit", "http://iec.ch/TC57/CIM100#"),
            Map.entry("y1Unit", "http://iec.ch/TC57/CIM100#"),
            Map.entry("y2Unit", "http://iec.ch/TC57/CIM100#"),
