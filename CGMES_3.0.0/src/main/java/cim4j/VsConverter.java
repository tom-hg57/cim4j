...
public class VsConverter extends ACDCConverter {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("CapabilityCurve", "http://iec.ch/TC57/CIM100#"),
            Map.entry("VSCDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("delta", "http://iec.ch/TC57/CIM100#"),
            Map.entry("droop", "http://iec.ch/TC57/CIM100#"),
            Map.entry("droopCompensation", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maxModulationIndex", "http://iec.ch/TC57/CIM100#"),
            Map.entry("pPccControl", "http://iec.ch/TC57/CIM100#"),
            Map.entry("qPccControl", "http://iec.ch/TC57/CIM100#"),
            Map.entry("qShare", "http://iec.ch/TC57/CIM100#"),
            Map.entry("targetPWMfactor", "http://iec.ch/TC57/CIM100#"),
            Map.entry("targetPhasePcc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("targetPowerFactorPcc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("targetQpcc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("targetUpcc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("uv", "http://iec.ch/TC57/CIM100#"),
