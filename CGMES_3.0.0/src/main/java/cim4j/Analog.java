...
public class Analog extends Measurement {
    ...
    static {
        ATTR_NAMESPACE_MAP = new Analog().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("AnalogValues", "http://iec.ch/TC57/CIM100#"),
            Map.entry("LimitSets", "http://iec.ch/TC57/CIM100#"),
            Map.entry("positiveFlowIn", "http://iec.ch/TC57/CIM100#"),
