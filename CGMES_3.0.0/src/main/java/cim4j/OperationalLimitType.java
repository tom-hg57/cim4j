...
public class OperationalLimitType extends IdentifiedObject {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("OperationalLimit", "http://iec.ch/TC57/CIM100#"),
            Map.entry("acceptableDuration", "http://iec.ch/TC57/CIM100#"),
            Map.entry("direction", "http://iec.ch/TC57/CIM100#"),
            Map.entry("isInfiniteDuration", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kind", "http://iec.ch/TC57/CIM100-European#"),
