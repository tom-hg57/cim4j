...
public class GovSteam0 extends TurbineGovernorDynamics {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new GovSteam0().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(GovSteam0_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(GovSteam0_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated GovSteam0, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated GovSteam0, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            GovSteam0_primitive_builder attrEnum = GovSteam0_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = GovSteam0_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            GovSteam0_class_attributes_enum attrEnum = GovSteam0_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = GovSteam0_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : GovSteam0_primitive_builder.values()) {
            if (enumValue != GovSteam0_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "GovSteam0." + enumValue.name());
            }
        }
        for (var enumValue : GovSteam0_class_attributes_enum.values()) {
            if (enumValue != GovSteam0_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "GovSteam0." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "GovSteam0";
    ...
    static {
        ATTR_NAMESPACE_MAP = new GovSteam0().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("dt", "http://iec.ch/TC57/CIM100#"),
