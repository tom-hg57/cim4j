...
public class TurbineLoadControllerDynamics extends DynamicsFunctionBlock {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new TurbineLoadControllerDynamics().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(TurbineLoadControllerDynamics_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(TurbineLoadControllerDynamics_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated TurbineLoadControllerDynamics, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated TurbineLoadControllerDynamics, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            TurbineLoadControllerDynamics_primitive_builder attrEnum = TurbineLoadControllerDynamics_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = TurbineLoadControllerDynamics_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            TurbineLoadControllerDynamics_class_attributes_enum attrEnum = TurbineLoadControllerDynamics_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = TurbineLoadControllerDynamics_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : TurbineLoadControllerDynamics_primitive_builder.values()) {
            if (enumValue != TurbineLoadControllerDynamics_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "TurbineLoadControllerDynamics." + enumValue.name());
            }
        }
        for (var enumValue : TurbineLoadControllerDynamics_class_attributes_enum.values()) {
            if (enumValue != TurbineLoadControllerDynamics_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "TurbineLoadControllerDynamics." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "TurbineLoadControllerDynamics";
    ...
    static {
        ATTR_NAMESPACE_MAP = new TurbineLoadControllerDynamics().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("TurbineGovernorDynamics", "http://iec.ch/TC57/CIM100#"),
