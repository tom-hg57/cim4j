...
public final class CimClassMap {
    ...
    private final Map<String, Function<Iterable<BaseClass>, Iterable<BaseClass>>> SAVE_MAP;
    {
        ...
        map.put("DiagramLayoutVersion", objList -> saveAll(repoDiagramLayoutVersion, objList));
        ...
        map.put("DynamicsVersion", objList -> saveAll(repoDynamicsVersion, objList));
        ...
        map.put("EquipmentBoundaryVersion", objList -> saveAll(repoEquipmentBoundaryVersion, objList));
        map.put("EquipmentContainer", objList -> saveAll(repoEquipmentContainer, objList));
        map.put("EquipmentVersion", objList -> saveAll(repoEquipmentVersion, objList));
        ...
        map.put("GeographicalLocationVersion", objList -> saveAll(repoGeographicalLocationVersion, objList));
        ...
        map.put("PerLengthDCLineParameter", objList -> saveAll(repoPerLengthDCLineParameter, objList));
        ...
        map.put("StateVariablesVersion", objList -> saveAll(repoStateVariablesVersion, objList));
        ...
        map.put("SteadyStateHypothesisVersion", objList -> saveAll(repoSteadyStateHypothesisVersion, objList));
        ...
        map.put("TopologyBoundaryVersion", objList -> saveAll(repoTopologyBoundaryVersion, objList));
        map.put("TopologyVersion", objList -> saveAll(repoTopologyVersion, objList));
        ...
        map.put("WindAeroLinearIEC", objList -> saveAll(repoWindAeroLinearIEC, objList));
        ...
        map.put("WindGenTurbineType1IEC", objList -> saveAll(repoWindGenTurbineType1IEC, objList));
        map.put("WindGenTurbineType2IEC", objList -> saveAll(repoWindGenTurbineType2IEC, objList));
        map.put("WindGenTurbineType3IEC", objList -> saveAll(repoWindGenTurbineType3IEC, objList));
        map.put("WindGenTurbineType3aIEC", objList -> saveAll(repoWindGenTurbineType3aIEC, objList));
        map.put("WindGenTurbineType3bIEC", objList -> saveAll(repoWindGenTurbineType3bIEC, objList));
        ...
        map.put("WindPitchContEmulIEC", objList -> saveAll(repoWindPitchContEmulIEC, objList));
    ...
    private final Map<String, Function<Iterable<Long>, Iterable<BaseClass>>> READ_MAP;
    {
        ...
        map.put("DiagramLayoutVersion", idList -> findAllById(repoDiagramLayoutVersion, idList));
        ...
        map.put("DynamicsVersion", idList -> findAllById(repoDynamicsVersion, idList));
        ...
        map.put("EquipmentBoundaryVersion", idList -> findAllById(repoEquipmentBoundaryVersion, idList));
        map.put("EquipmentContainer", idList -> findAllById(repoEquipmentContainer, idList));
        map.put("EquipmentVersion", idList -> findAllById(repoEquipmentVersion, idList));
        ...
        map.put("GeographicalLocationVersion", idList -> findAllById(repoGeographicalLocationVersion, idList));
        ...
        map.put("PerLengthDCLineParameter", idList -> findAllById(repoPerLengthDCLineParameter, idList));
        ...
        map.put("StateVariablesVersion", idList -> findAllById(repoStateVariablesVersion, idList));
        ...
        map.put("SteadyStateHypothesisVersion", idList -> findAllById(repoSteadyStateHypothesisVersion, idList));
        ...
        map.put("TopologyBoundaryVersion", idList -> findAllById(repoTopologyBoundaryVersion, idList));
        map.put("TopologyVersion", idList -> findAllById(repoTopologyVersion, idList));
        ...
        map.put("WindAeroLinearIEC", idList -> findAllById(repoWindAeroLinearIEC, idList));
        ...
        map.put("WindGenTurbineType1IEC", idList -> findAllById(repoWindGenTurbineType1IEC, idList));
        map.put("WindGenTurbineType2IEC", idList -> findAllById(repoWindGenTurbineType2IEC, idList));
        map.put("WindGenTurbineType3IEC", idList -> findAllById(repoWindGenTurbineType3IEC, idList));
        map.put("WindGenTurbineType3aIEC", idList -> findAllById(repoWindGenTurbineType3aIEC, idList));
        map.put("WindGenTurbineType3bIEC", idList -> findAllById(repoWindGenTurbineType3bIEC, idList));
        ...
        map.put("WindPitchContEmulIEC", idList -> findAllById(repoWindPitchContEmulIEC, idList));
    ...
    private final Map<String, Consumer<Iterable<Long>>> DELETE_MAP;
    {
        ...
        map.put("DiagramLayoutVersion", idList -> repoDiagramLayoutVersion.deleteAllById(idList));
        ...
        map.put("DynamicsVersion", idList -> repoDynamicsVersion.deleteAllById(idList));
        ...
        map.put("EquipmentBoundaryVersion", idList -> repoEquipmentBoundaryVersion.deleteAllById(idList));
        map.put("EquipmentContainer", idList -> repoEquipmentContainer.deleteAllById(idList));
        map.put("EquipmentVersion", idList -> repoEquipmentVersion.deleteAllById(idList));
        ...
        map.put("GeographicalLocationVersion", idList -> repoGeographicalLocationVersion.deleteAllById(idList));
        ...
        map.put("PerLengthDCLineParameter", idList -> repoPerLengthDCLineParameter.deleteAllById(idList));
        ...
        map.put("StateVariablesVersion", idList -> repoStateVariablesVersion.deleteAllById(idList));
        ...
        map.put("SteadyStateHypothesisVersion", idList -> repoSteadyStateHypothesisVersion.deleteAllById(idList));
        ...
        map.put("TopologyBoundaryVersion", idList -> repoTopologyBoundaryVersion.deleteAllById(idList));
        map.put("TopologyVersion", idList -> repoTopologyVersion.deleteAllById(idList));
        ...
        map.put("WindAeroLinearIEC", idList -> repoWindAeroLinearIEC.deleteAllById(idList));
        ...
        map.put("WindGenTurbineType1IEC", idList -> repoWindGenTurbineType1IEC.deleteAllById(idList));
        map.put("WindGenTurbineType2IEC", idList -> repoWindGenTurbineType2IEC.deleteAllById(idList));
        map.put("WindGenTurbineType3IEC", idList -> repoWindGenTurbineType3IEC.deleteAllById(idList));
        map.put("WindGenTurbineType3aIEC", idList -> repoWindGenTurbineType3aIEC.deleteAllById(idList));
        map.put("WindGenTurbineType3bIEC", idList -> repoWindGenTurbineType3bIEC.deleteAllById(idList));
        ...
        map.put("WindPitchContEmulIEC", idList -> repoWindPitchContEmulIEC.deleteAllById(idList));
