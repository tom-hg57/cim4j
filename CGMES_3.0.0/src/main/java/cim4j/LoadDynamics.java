...
public class LoadDynamics extends IdentifiedObject {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new LoadDynamics().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(LoadDynamics_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(LoadDynamics_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated LoadDynamics, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated LoadDynamics, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            LoadDynamics_primitive_builder attrEnum = LoadDynamics_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = LoadDynamics_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            LoadDynamics_class_attributes_enum attrEnum = LoadDynamics_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = LoadDynamics_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : LoadDynamics_primitive_builder.values()) {
            if (enumValue != LoadDynamics_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "LoadDynamics." + enumValue.name());
            }
        }
        for (var enumValue : LoadDynamics_class_attributes_enum.values()) {
            if (enumValue != LoadDynamics_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "LoadDynamics." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "LoadDynamics";
    ...
    static {
        ATTR_NAMESPACE_MAP = new LoadDynamics().allAttrNamespaceMap();
    }
