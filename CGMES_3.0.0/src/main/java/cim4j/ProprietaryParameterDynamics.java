...
public class ProprietaryParameterDynamics extends BaseClass {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("AsynchronousMachineUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("CSCUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("DiscontinuousExcitationControlUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ExcitationSystemUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("LoadUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("MechanicalLoadUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("OverexcitationLimiterUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PFVArControllerType1UserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PFVArControllerType2UserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PowerSystemStabilizerUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SVCUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SynchronousMachineUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TurbineGovernorUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TurbineLoadControllerUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("UnderexcitationLimiterUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("VSCUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("VoltageAdjusterUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("VoltageCompensatorUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("WindPlantUserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("WindType1or2UserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("WindType3or4UserDefined", "http://iec.ch/TC57/CIM100#"),
            Map.entry("booleanParameterValue", "http://iec.ch/TC57/CIM100#"),
            Map.entry("floatParameterValue", "http://iec.ch/TC57/CIM100#"),
            Map.entry("integerParameterValue", "http://iec.ch/TC57/CIM100#"),
            Map.entry("parameterNumber", "http://iec.ch/TC57/CIM100#"),
