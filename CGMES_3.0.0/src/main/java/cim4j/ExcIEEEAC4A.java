...
public class ExcIEEEAC4A extends ExcitationSystemDynamics {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new ExcIEEEAC4A().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(ExcIEEEAC4A_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(ExcIEEEAC4A_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated ExcIEEEAC4A, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated ExcIEEEAC4A, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            ExcIEEEAC4A_primitive_builder attrEnum = ExcIEEEAC4A_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = ExcIEEEAC4A_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            ExcIEEEAC4A_class_attributes_enum attrEnum = ExcIEEEAC4A_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = ExcIEEEAC4A_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : ExcIEEEAC4A_primitive_builder.values()) {
            if (enumValue != ExcIEEEAC4A_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "ExcIEEEAC4A." + enumValue.name());
            }
        }
        for (var enumValue : ExcIEEEAC4A_class_attributes_enum.values()) {
            if (enumValue != ExcIEEEAC4A_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "ExcIEEEAC4A." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "ExcIEEEAC4A";
    ...
    static {
        ATTR_NAMESPACE_MAP = new ExcIEEEAC4A().allAttrNamespaceMap();
    }
