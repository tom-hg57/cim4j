...
public class SvPowerFlow extends BaseClass {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new SvPowerFlow().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(SvPowerFlow_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(SvPowerFlow_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated SvPowerFlow, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated SvPowerFlow, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            SvPowerFlow_primitive_builder attrEnum = SvPowerFlow_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SvPowerFlow_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            SvPowerFlow_class_attributes_enum attrEnum = SvPowerFlow_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SvPowerFlow_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : SvPowerFlow_primitive_builder.values()) {
            if (enumValue != SvPowerFlow_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SvPowerFlow." + enumValue.name());
            }
        }
        for (var enumValue : SvPowerFlow_class_attributes_enum.values()) {
            if (enumValue != SvPowerFlow_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SvPowerFlow." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "SvPowerFlow";
    ...
    static {
        ATTR_NAMESPACE_MAP = new SvPowerFlow().allAttrNamespaceMap();
    }
