...
public class ExcSCRX extends ExcitationSystemDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ExcSCRX().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("cswitch", "http://iec.ch/TC57/CIM100#"),
            Map.entry("emax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("emin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("k", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rcrfd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tatb", "http://iec.ch/TC57/CIM100#"),
