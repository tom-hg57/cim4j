...
public class LoadComposite extends LoadDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("epfd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("epfs", "http://iec.ch/TC57/CIM100#"),
            Map.entry("epvd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("epvs", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eqfd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eqfs", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eqvd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eqvs", "http://iec.ch/TC57/CIM100#"),
            Map.entry("h", "http://iec.ch/TC57/CIM100#"),
            Map.entry("lfac", "http://iec.ch/TC57/CIM100#"),
            Map.entry("pfrac", "http://iec.ch/TC57/CIM100#"),
