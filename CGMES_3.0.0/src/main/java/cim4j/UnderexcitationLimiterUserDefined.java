...
public class UnderexcitationLimiterUserDefined extends UnderexcitationLimiterDynamics {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new UnderexcitationLimiterUserDefined().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(UnderexcitationLimiterUserDefined_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(UnderexcitationLimiterUserDefined_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated UnderexcitationLimiterUserDefined, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated UnderexcitationLimiterUserDefined, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            UnderexcitationLimiterUserDefined_primitive_builder attrEnum = UnderexcitationLimiterUserDefined_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = UnderexcitationLimiterUserDefined_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            UnderexcitationLimiterUserDefined_class_attributes_enum attrEnum = UnderexcitationLimiterUserDefined_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = UnderexcitationLimiterUserDefined_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : UnderexcitationLimiterUserDefined_primitive_builder.values()) {
            if (enumValue != UnderexcitationLimiterUserDefined_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "UnderexcitationLimiterUserDefined." + enumValue.name());
            }
        }
        for (var enumValue : UnderexcitationLimiterUserDefined_class_attributes_enum.values()) {
            if (enumValue != UnderexcitationLimiterUserDefined_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "UnderexcitationLimiterUserDefined." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "UnderexcitationLimiterUserDefined";
    ...
    static {
        ATTR_NAMESPACE_MAP = new UnderexcitationLimiterUserDefined().allAttrNamespaceMap();
    }
