...
public class Control extends IOPoint {
    ...
    static {
        ATTR_NAMESPACE_MAP = new Control().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("PowerSystemResource", "http://iec.ch/TC57/CIM100#"),
            Map.entry("controlType", "http://iec.ch/TC57/CIM100#"),
            Map.entry("operationInProgress", "http://iec.ch/TC57/CIM100#"),
            Map.entry("timeStamp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("unitMultiplier", "http://iec.ch/TC57/CIM100#"),
            Map.entry("unitSymbol", "http://iec.ch/TC57/CIM100#"),
