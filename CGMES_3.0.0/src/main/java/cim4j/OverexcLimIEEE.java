...
public class OverexcLimIEEE extends OverexcitationLimiterDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new OverexcLimIEEE().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("hyst", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ifdlim", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ifdmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("itfpu", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kcd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kramp", "http://iec.ch/TC57/CIM100#"),
