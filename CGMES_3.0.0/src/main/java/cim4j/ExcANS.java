...
public class ExcANS extends ExcitationSystemDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("blint", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ifmn", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ifmx", "http://iec.ch/TC57/CIM100#"),
            Map.entry("k2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("k3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kce", "http://iec.ch/TC57/CIM100#"),
            Map.entry("krvecc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kvfif", "http://iec.ch/TC57/CIM100#"),
