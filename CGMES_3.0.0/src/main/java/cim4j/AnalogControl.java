...
public class AnalogControl extends Control {
    ...
    static {
        ATTR_NAMESPACE_MAP = new AnalogControl().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("AnalogValue", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maxValue", "http://iec.ch/TC57/CIM100#"),
            Map.entry("minValue", "http://iec.ch/TC57/CIM100#"),
