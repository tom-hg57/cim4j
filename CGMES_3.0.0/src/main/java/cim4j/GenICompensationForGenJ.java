...
public class GenICompensationForGenJ extends IdentifiedObject {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new GenICompensationForGenJ().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(GenICompensationForGenJ_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(GenICompensationForGenJ_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated GenICompensationForGenJ, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated GenICompensationForGenJ, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            GenICompensationForGenJ_primitive_builder attrEnum = GenICompensationForGenJ_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = GenICompensationForGenJ_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            GenICompensationForGenJ_class_attributes_enum attrEnum = GenICompensationForGenJ_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = GenICompensationForGenJ_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : GenICompensationForGenJ_primitive_builder.values()) {
            if (enumValue != GenICompensationForGenJ_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "GenICompensationForGenJ." + enumValue.name());
            }
        }
        for (var enumValue : GenICompensationForGenJ_class_attributes_enum.values()) {
            if (enumValue != GenICompensationForGenJ_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "GenICompensationForGenJ." + enumValue.name());
            }
        }
    ...
    static {
        ATTR_NAMESPACE_MAP = new GenICompensationForGenJ().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("SynchronousMachineDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("VcompIEEEType2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rcij", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xcij", "http://iec.ch/TC57/CIM100#"),
