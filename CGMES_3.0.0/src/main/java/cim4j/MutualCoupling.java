...
public class MutualCoupling extends IdentifiedObject {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("First_Terminal", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Second_Terminal", "http://iec.ch/TC57/CIM100#"),
            Map.entry("b0ch", "http://iec.ch/TC57/CIM100#"),
            Map.entry("distance11", "http://iec.ch/TC57/CIM100#"),
            Map.entry("distance12", "http://iec.ch/TC57/CIM100#"),
            Map.entry("distance21", "http://iec.ch/TC57/CIM100#"),
            Map.entry("distance22", "http://iec.ch/TC57/CIM100#"),
