...
public class ExcST4B extends ExcitationSystemDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("kim", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kir", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kpm", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kpr", "http://iec.ch/TC57/CIM100#"),
            Map.entry("lvgate", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ta", "http://iec.ch/TC57/CIM100#"),
            Map.entry("thetap", "http://iec.ch/TC57/CIM100#"),
            Map.entry("uel", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vbmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vgmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vmmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vmmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vrmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vrmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xl", "http://iec.ch/TC57/CIM100#"),
