...
public class RegularTimePoint extends BaseClass {
    ...
    static {
        ATTR_NAMESPACE_MAP = new RegularTimePoint().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("IntervalSchedule", "http://iec.ch/TC57/CIM100#"),
            Map.entry("sequenceNumber", "http://iec.ch/TC57/CIM100#"),
            Map.entry("value1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("value2", "http://iec.ch/TC57/CIM100#"),
