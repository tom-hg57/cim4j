...
public class WindPlantFreqPcontrolIEC extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindPlantFreqPcontrolIEC().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("dpwprefmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("dpwprefmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kiwpp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kiwppmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kiwppmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kpwpp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kwppref", "http://iec.ch/TC57/CIM100#"),
            Map.entry("prefmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("prefmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpft", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpfv", "http://iec.ch/TC57/CIM100#"),
            Map.entry("twpffiltp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("twppfiltp", "http://iec.ch/TC57/CIM100#"),
