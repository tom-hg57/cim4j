...
public class StringMeasurement extends Measurement {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new StringMeasurement().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(StringMeasurement_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(StringMeasurement_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated StringMeasurement, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated StringMeasurement, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            StringMeasurement_primitive_builder attrEnum = StringMeasurement_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = StringMeasurement_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            StringMeasurement_class_attributes_enum attrEnum = StringMeasurement_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = StringMeasurement_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : StringMeasurement_primitive_builder.values()) {
            if (enumValue != StringMeasurement_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "StringMeasurement." + enumValue.name());
            }
        }
        for (var enumValue : StringMeasurement_class_attributes_enum.values()) {
            if (enumValue != StringMeasurement_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "StringMeasurement." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "StringMeasurement";
    ...
    static {
        ATTR_NAMESPACE_MAP = new StringMeasurement().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("StringMeasurementValues", "http://iec.ch/TC57/CIM100#"),
