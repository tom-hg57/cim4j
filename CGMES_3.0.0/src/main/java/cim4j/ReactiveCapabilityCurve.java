...
public class ReactiveCapabilityCurve extends Curve {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ReactiveCapabilityCurve().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("EquivalentInjection", "http://iec.ch/TC57/CIM100#"),
            Map.entry("InitiallyUsedBySynchronousMachines", "http://iec.ch/TC57/CIM100#"),
