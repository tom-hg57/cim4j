...
public class Location extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new Location().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("CoordinateSystem", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PositionPoints", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PowerSystemResources", "http://iec.ch/TC57/CIM100#"),
            Map.entry("mainAddress", "http://iec.ch/TC57/CIM100#"),
