...
public class Disconnector extends Switch {
    ...
    private static final Logging LOG = Logging.getLogger(Disconnector.class);
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new Disconnector().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(Disconnector_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(Disconnector_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated Disconnector, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated Disconnector, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            Disconnector_primitive_builder attrEnum = Disconnector_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = Disconnector_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            Disconnector_class_attributes_enum attrEnum = Disconnector_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = Disconnector_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : Disconnector_primitive_builder.values()) {
            if (enumValue != Disconnector_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "Disconnector." + enumValue.name());
            }
        }
        for (var enumValue : Disconnector_class_attributes_enum.values()) {
            if (enumValue != Disconnector_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "Disconnector." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "Disconnector";
    ...
    static {
        ATTR_NAMESPACE_MAP = new Disconnector().allAttrNamespaceMap();
    }
