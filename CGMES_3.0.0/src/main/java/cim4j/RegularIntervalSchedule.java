...
public class RegularIntervalSchedule extends BasicIntervalSchedule {
    ...
    static {
        ATTR_NAMESPACE_MAP = new RegularIntervalSchedule().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("TimePoints", "http://iec.ch/TC57/CIM100#"),
            Map.entry("endTime", "http://iec.ch/TC57/CIM100#"),
            Map.entry("timeStep", "http://iec.ch/TC57/CIM100#"),
