...
public class LoadGroup extends IdentifiedObject {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new LoadGroup().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(LoadGroup_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(LoadGroup_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated LoadGroup, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated LoadGroup, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            LoadGroup_primitive_builder attrEnum = LoadGroup_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = LoadGroup_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            LoadGroup_class_attributes_enum attrEnum = LoadGroup_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = LoadGroup_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : LoadGroup_primitive_builder.values()) {
            if (enumValue != LoadGroup_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "LoadGroup." + enumValue.name());
            }
        }
        for (var enumValue : LoadGroup_class_attributes_enum.values()) {
            if (enumValue != LoadGroup_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "LoadGroup." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "LoadGroup";
    ...
    static {
        ATTR_NAMESPACE_MAP = new LoadGroup().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("SubLoadArea", "http://iec.ch/TC57/CIM100#"),
