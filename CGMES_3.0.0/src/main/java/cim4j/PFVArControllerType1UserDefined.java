...
public class PFVArControllerType1UserDefined extends PFVArControllerType1Dynamics {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new PFVArControllerType1UserDefined().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(PFVArControllerType1UserDefined_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(PFVArControllerType1UserDefined_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated PFVArControllerType1UserDefined, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated PFVArControllerType1UserDefined, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            PFVArControllerType1UserDefined_primitive_builder attrEnum = PFVArControllerType1UserDefined_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PFVArControllerType1UserDefined_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            PFVArControllerType1UserDefined_class_attributes_enum attrEnum = PFVArControllerType1UserDefined_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PFVArControllerType1UserDefined_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : PFVArControllerType1UserDefined_primitive_builder.values()) {
            if (enumValue != PFVArControllerType1UserDefined_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PFVArControllerType1UserDefined." + enumValue.name());
            }
        }
        for (var enumValue : PFVArControllerType1UserDefined_class_attributes_enum.values()) {
            if (enumValue != PFVArControllerType1UserDefined_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PFVArControllerType1UserDefined." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "PFVArControllerType1UserDefined";
    ...
    static {
        ATTR_NAMESPACE_MAP = new PFVArControllerType1UserDefined().allAttrNamespaceMap();
    }
