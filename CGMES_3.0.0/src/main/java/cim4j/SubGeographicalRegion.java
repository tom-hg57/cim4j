...
public class SubGeographicalRegion extends IdentifiedObject {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new SubGeographicalRegion().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(SubGeographicalRegion_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(SubGeographicalRegion_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated SubGeographicalRegion, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated SubGeographicalRegion, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            SubGeographicalRegion_primitive_builder attrEnum = SubGeographicalRegion_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SubGeographicalRegion_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            SubGeographicalRegion_class_attributes_enum attrEnum = SubGeographicalRegion_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SubGeographicalRegion_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : SubGeographicalRegion_primitive_builder.values()) {
            if (enumValue != SubGeographicalRegion_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SubGeographicalRegion." + enumValue.name());
            }
        }
        for (var enumValue : SubGeographicalRegion_class_attributes_enum.values()) {
            if (enumValue != SubGeographicalRegion_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SubGeographicalRegion." + enumValue.name());
            }
        }
    ...
    static {
        ATTR_NAMESPACE_MAP = new SubGeographicalRegion().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("DCLines", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Lines", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Region", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Substations", "http://iec.ch/TC57/CIM100#"),
