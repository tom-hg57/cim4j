...
public class PowerTransformerEnd extends TransformerEnd {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("PowerTransformer", "http://iec.ch/TC57/CIM100#"),
            Map.entry("b", "http://iec.ch/TC57/CIM100#"),
            Map.entry("b0", "http://iec.ch/TC57/CIM100#"),
            Map.entry("connectionKind", "http://iec.ch/TC57/CIM100#"),
            Map.entry("g", "http://iec.ch/TC57/CIM100#"),
            Map.entry("g0", "http://iec.ch/TC57/CIM100#"),
            Map.entry("phaseAngleClock", "http://iec.ch/TC57/CIM100#"),
