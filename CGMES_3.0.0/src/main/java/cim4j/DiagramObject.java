...
public class DiagramObject extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new DiagramObject().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("Diagram", "http://iec.ch/TC57/CIM100#"),
            Map.entry("DiagramObjectPoints", "http://iec.ch/TC57/CIM100#"),
            Map.entry("DiagramObjectStyle", "http://iec.ch/TC57/CIM100#"),
            Map.entry("IdentifiedObject", "http://iec.ch/TC57/CIM100#"),
            Map.entry("VisibilityLayers", "http://iec.ch/TC57/CIM100#"),
            Map.entry("drawingOrder", "http://iec.ch/TC57/CIM100#"),
            Map.entry("isPolygon", "http://iec.ch/TC57/CIM100#"),
            Map.entry("offsetX", "http://iec.ch/TC57/CIM100#"),
            Map.entry("offsetY", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rotation", "http://iec.ch/TC57/CIM100#"),
