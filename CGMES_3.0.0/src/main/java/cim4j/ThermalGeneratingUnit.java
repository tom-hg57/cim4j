...
public class ThermalGeneratingUnit extends GeneratingUnit {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ThermalGeneratingUnit().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("CAESPlant", "http://iec.ch/TC57/CIM100#"),
            Map.entry("CogenerationPlant", "http://iec.ch/TC57/CIM100#"),
            Map.entry("CombinedCyclePlant", "http://iec.ch/TC57/CIM100#"),
            Map.entry("FossilFuels", "http://iec.ch/TC57/CIM100#"),
