...
public class WindTurbineType3or4Dynamics extends DynamicsFunctionBlock {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new WindTurbineType3or4Dynamics().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(WindTurbineType3or4Dynamics_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(WindTurbineType3or4Dynamics_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated WindTurbineType3or4Dynamics, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated WindTurbineType3or4Dynamics, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            WindTurbineType3or4Dynamics_primitive_builder attrEnum = WindTurbineType3or4Dynamics_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindTurbineType3or4Dynamics_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            WindTurbineType3or4Dynamics_class_attributes_enum attrEnum = WindTurbineType3or4Dynamics_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindTurbineType3or4Dynamics_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : WindTurbineType3or4Dynamics_primitive_builder.values()) {
            if (enumValue != WindTurbineType3or4Dynamics_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindTurbineType3or4Dynamics." + enumValue.name());
            }
        }
        for (var enumValue : WindTurbineType3or4Dynamics_class_attributes_enum.values()) {
            if (enumValue != WindTurbineType3or4Dynamics_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindTurbineType3or4Dynamics." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "WindTurbineType3or4Dynamics";
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindTurbineType3or4Dynamics().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("WindPlantDynamics", "http://iec.ch/TC57/CIM100#"),
