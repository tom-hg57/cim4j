...
public class ConnectivityNode extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ConnectivityNode().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("BoundaryPoint", "http://iec.ch/TC57/CIM100-European#"),
            Map.entry("ConnectivityNodeContainer", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Terminals", "http://iec.ch/TC57/CIM100#"),
