...
public class StaticVarCompensator extends RegulatingCondEq {
    ...
    static {
        ATTR_NAMESPACE_MAP = new StaticVarCompensator().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("StaticVarCompensatorDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("capacitiveRating", "http://iec.ch/TC57/CIM100#"),
            Map.entry("inductiveRating", "http://iec.ch/TC57/CIM100#"),
            Map.entry("q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("sVCControlMode", "http://iec.ch/TC57/CIM100#"),
            Map.entry("slope", "http://iec.ch/TC57/CIM100#"),
            Map.entry("voltageSetPoint", "http://iec.ch/TC57/CIM100#"),
