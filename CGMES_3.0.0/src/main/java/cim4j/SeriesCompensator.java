...
public class SeriesCompensator extends ConductingEquipment {
    ...
    static {
        ATTR_NAMESPACE_MAP = new SeriesCompensator().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("varistorPresent", "http://iec.ch/TC57/CIM100#"),
            Map.entry("varistorRatedCurrent", "http://iec.ch/TC57/CIM100#"),
            Map.entry("varistorVoltageThreshold", "http://iec.ch/TC57/CIM100#"),
