...
public class SynchronousMachineDynamics extends RotatingMachineDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("CrossCompoundTurbineGovernorDyanmics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("CrossCompoundTurbineGovernorDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ExcitationSystemDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("GenICompensationForGenJ", "http://iec.ch/TC57/CIM100#"),
            Map.entry("MechanicalLoadDynamics", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SynchronousMachine", "http://iec.ch/TC57/CIM100#"),
