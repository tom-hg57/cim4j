...
public class PssIEEE2B extends PowerSystemStabilizerDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new PssIEEE2B().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("inputSignal1Type", "http://iec.ch/TC57/CIM100#"),
            Map.entry("inputSignal2Type", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ks1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ks2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ks3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("m", "http://iec.ch/TC57/CIM100#"),
            Map.entry("n", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t10", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t11", "http://iec.ch/TC57/CIM100#"),
            ...
            Map.entry("t8", "http://iec.ch/TC57/CIM100#"),
            Map.entry("t9", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tw1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tw2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tw3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tw4", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vsi1max", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vsi1min", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vsi2max", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vsi2min", "http://iec.ch/TC57/CIM100#"),
