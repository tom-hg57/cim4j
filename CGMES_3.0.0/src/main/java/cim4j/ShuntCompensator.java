...
public class ShuntCompensator extends RegulatingCondEq {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("SvShuntCompensatorSections", "http://iec.ch/TC57/CIM100#"),
            Map.entry("aVRDelay", "http://iec.ch/TC57/CIM100#"),
            Map.entry("grounded", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maximumSections", "http://iec.ch/TC57/CIM100#"),
            Map.entry("nomU", "http://iec.ch/TC57/CIM100#"),
            Map.entry("normalSections", "http://iec.ch/TC57/CIM100#"),
            Map.entry("sections", "http://iec.ch/TC57/CIM100#"),
            Map.entry("voltageSensitivity", "http://iec.ch/TC57/CIM100#"),
