...
public class WindContQIEC extends IdentifiedObject {
    ...
    private enum WindContQIEC_primitive_builder implements PrimitiveBuilder {
        ...
        windQcontrolModesType() {
            public BaseClass construct(java.lang.String value) {
                return new WindQcontrolModeKind(value);
            }
        },
        windUVRTQcontrolModesType() {
            public BaseClass construct(java.lang.String value) {
                return new WindUVRTQcontrolModeKind(value);
            }
        },
        xdroop() {
            public BaseClass construct(java.lang.String value) {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("iqh1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("iqmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("iqmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("iqpost", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kiq", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kiu", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kpq", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kpu", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kqv", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rdroop", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpfiltq", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpost", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tqord", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tufiltq", "http://iec.ch/TC57/CIM100#"),
            Map.entry("udb1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("udb2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("umax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("umin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("uqdip", "http://iec.ch/TC57/CIM100#"),
            Map.entry("uref0", "http://iec.ch/TC57/CIM100#"),
            Map.entry("windQcontrolModesType", "http://iec.ch/TC57/CIM100#"),
            Map.entry("windUVRTQcontrolModesType", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xdroop", "http://iec.ch/TC57/CIM100#"),
