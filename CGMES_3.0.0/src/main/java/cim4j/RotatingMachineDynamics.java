...
public class RotatingMachineDynamics extends DynamicsFunctionBlock {
    ...
    static {
        ATTR_NAMESPACE_MAP = new RotatingMachineDynamics().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("damping", "http://iec.ch/TC57/CIM100#"),
            Map.entry("inertia", "http://iec.ch/TC57/CIM100#"),
            Map.entry("saturationFactor", "http://iec.ch/TC57/CIM100#"),
            Map.entry("saturationFactor120", "http://iec.ch/TC57/CIM100#"),
            Map.entry("statorLeakageReactance", "http://iec.ch/TC57/CIM100#"),
            Map.entry("statorResistance", "http://iec.ch/TC57/CIM100#"),
