...
public class FossilFuel extends IdentifiedObject {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new FossilFuel().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(FossilFuel_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(FossilFuel_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated FossilFuel, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated FossilFuel, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            FossilFuel_primitive_builder attrEnum = FossilFuel_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = FossilFuel_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            FossilFuel_class_attributes_enum attrEnum = FossilFuel_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = FossilFuel_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : FossilFuel_primitive_builder.values()) {
            if (enumValue != FossilFuel_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "FossilFuel." + enumValue.name());
            }
        }
        for (var enumValue : FossilFuel_class_attributes_enum.values()) {
            if (enumValue != FossilFuel_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "FossilFuel." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "FossilFuel";
    ...
    static {
        ATTR_NAMESPACE_MAP = new FossilFuel().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("fossilFuelType", "http://iec.ch/TC57/CIM100#"),
