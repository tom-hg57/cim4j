...
public class PssELIN2 extends PowerSystemStabilizerDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("apss", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ks1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ks2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ppss", "http://iec.ch/TC57/CIM100#"),
            Map.entry("psslim", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts4", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts5", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ts6", "http://iec.ch/TC57/CIM100#"),
