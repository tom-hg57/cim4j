...
public class GeneratingUnit extends Equipment {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("GrossToNetActivePowerCurves", "http://iec.ch/TC57/CIM100#"),
            Map.entry("RotatingMachine", "http://iec.ch/TC57/CIM100#"),
            Map.entry("genControlSource", "http://iec.ch/TC57/CIM100#"),
            Map.entry("governorSCD", "http://iec.ch/TC57/CIM100#"),
            Map.entry("longPF", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maxOperatingP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maximumAllowableSpinningReserve", "http://iec.ch/TC57/CIM100#"),
            Map.entry("minOperatingP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("nominalP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("normalPF", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ratedGrossMaxP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ratedGrossMinP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ratedNetMaxP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("shortPF", "http://iec.ch/TC57/CIM100#"),
            Map.entry("startupCost", "http://iec.ch/TC57/CIM100#"),
            Map.entry("startupTime", "http://iec.ch/TC57/CIM100#"),
            Map.entry("totalEfficiency", "http://iec.ch/TC57/CIM100#"),
            Map.entry("variableCost", "http://iec.ch/TC57/CIM100#"),
