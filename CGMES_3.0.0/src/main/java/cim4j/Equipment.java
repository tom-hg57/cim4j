...
public class Equipment extends PowerSystemResource {
    ...
    static {
        ATTR_NAMESPACE_MAP = new Equipment().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("EquipmentContainer", "http://iec.ch/TC57/CIM100#"),
            Map.entry("OperationalLimitSet", "http://iec.ch/TC57/CIM100#"),
            Map.entry("aggregate", "http://iec.ch/TC57/CIM100#"),
            Map.entry("inService", "http://iec.ch/TC57/CIM100#"),
            Map.entry("normallyInService", "http://iec.ch/TC57/CIM100#"),
