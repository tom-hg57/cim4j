...
public class TopologicalNode extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new TopologicalNode().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("AngleRefTopologicalIsland", "http://iec.ch/TC57/CIM100#"),
            Map.entry("BaseVoltage", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ConnectivityNodeContainer", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ConnectivityNodes", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ReportingGroup", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SvInjection", "http://iec.ch/TC57/CIM100#"),
            Map.entry("SvVoltage", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Terminal", "http://iec.ch/TC57/CIM100#"),
            Map.entry("TopologicalIsland", "http://iec.ch/TC57/CIM100#"),
