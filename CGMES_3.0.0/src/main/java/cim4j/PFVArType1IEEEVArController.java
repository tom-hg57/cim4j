...
public class PFVArType1IEEEVArController extends PFVArControllerType1Dynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new PFVArType1IEEEVArController().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("tvarc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vvar", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vvarcbw", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vvarref", "http://iec.ch/TC57/CIM100#"),
