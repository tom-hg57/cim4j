...
public class RaiseLowerCommand extends AnalogControl {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new RaiseLowerCommand().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(RaiseLowerCommand_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(RaiseLowerCommand_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated RaiseLowerCommand, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated RaiseLowerCommand, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            RaiseLowerCommand_primitive_builder attrEnum = RaiseLowerCommand_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = RaiseLowerCommand_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            RaiseLowerCommand_class_attributes_enum attrEnum = RaiseLowerCommand_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = RaiseLowerCommand_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : RaiseLowerCommand_primitive_builder.values()) {
            if (enumValue != RaiseLowerCommand_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "RaiseLowerCommand." + enumValue.name());
            }
        }
        for (var enumValue : RaiseLowerCommand_class_attributes_enum.values()) {
            if (enumValue != RaiseLowerCommand_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "RaiseLowerCommand." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "RaiseLowerCommand";
    ...
    static {
        ATTR_NAMESPACE_MAP = new RaiseLowerCommand().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("ValueAliasSet", "http://iec.ch/TC57/CIM100#"),
