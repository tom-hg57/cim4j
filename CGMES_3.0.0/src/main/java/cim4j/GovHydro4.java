...
public class GovHydro4 extends TurbineGovernorDynamics {
    ...
    private enum GovHydro4_primitive_builder implements PrimitiveBuilder {
        ...
        model() {
            public BaseClass construct(java.lang.String value) {
                return new GovHydro4ModelKind(value);
            }
        },
        mwbase() {
            public BaseClass construct(java.lang.String value) {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("at", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bgv0", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bgv1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bgv2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bgv3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bgv4", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bgv5", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("db1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("db2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("dturb", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eps", "http://iec.ch/TC57/CIM100#"),
            Map.entry("gmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("gmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("gv0", "http://iec.ch/TC57/CIM100#"),
            ...
            Map.entry("hdam", "http://iec.ch/TC57/CIM100#"),
            Map.entry("model", "http://iec.ch/TC57/CIM100#"),
            Map.entry("mwbase", "http://iec.ch/TC57/CIM100#"),
            Map.entry("pgv0", "http://iec.ch/TC57/CIM100#"),
            ...
            Map.entry("qnl", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rperm", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rtemp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tblade", "http://iec.ch/TC57/CIM100#"),
