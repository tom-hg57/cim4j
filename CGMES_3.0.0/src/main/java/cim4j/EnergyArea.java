...
public class EnergyArea extends IdentifiedObject {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new EnergyArea().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(EnergyArea_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(EnergyArea_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated EnergyArea, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated EnergyArea, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            EnergyArea_primitive_builder attrEnum = EnergyArea_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = EnergyArea_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            EnergyArea_class_attributes_enum attrEnum = EnergyArea_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = EnergyArea_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : EnergyArea_primitive_builder.values()) {
            if (enumValue != EnergyArea_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "EnergyArea." + enumValue.name());
            }
        }
        for (var enumValue : EnergyArea_class_attributes_enum.values()) {
            if (enumValue != EnergyArea_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "EnergyArea." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "EnergyArea";
    ...
    static {
        ATTR_NAMESPACE_MAP = new EnergyArea().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("ControlArea", "http://iec.ch/TC57/CIM100#"),
