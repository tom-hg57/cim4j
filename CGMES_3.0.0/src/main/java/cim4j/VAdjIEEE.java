...
public class VAdjIEEE extends VoltageAdjusterDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new VAdjIEEE().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("adjslew", "http://iec.ch/TC57/CIM100#"),
            Map.entry("taoff", "http://iec.ch/TC57/CIM100#"),
            Map.entry("taon", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vadjf", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vadjmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vadjmin", "http://iec.ch/TC57/CIM100#"),
