...
public class EquivalentEquipment extends ConductingEquipment {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new EquivalentEquipment().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(EquivalentEquipment_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(EquivalentEquipment_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated EquivalentEquipment, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated EquivalentEquipment, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            EquivalentEquipment_primitive_builder attrEnum = EquivalentEquipment_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = EquivalentEquipment_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            EquivalentEquipment_class_attributes_enum attrEnum = EquivalentEquipment_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = EquivalentEquipment_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : EquivalentEquipment_primitive_builder.values()) {
            if (enumValue != EquivalentEquipment_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "EquivalentEquipment." + enumValue.name());
            }
        }
        for (var enumValue : EquivalentEquipment_class_attributes_enum.values()) {
            if (enumValue != EquivalentEquipment_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "EquivalentEquipment." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "EquivalentEquipment";
    ...
    static {
        ATTR_NAMESPACE_MAP = new EquivalentEquipment().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("EquivalentNetwork", "http://iec.ch/TC57/CIM100#"),
