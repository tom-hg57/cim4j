...
public class WindPlantUserDefined extends WindPlantDynamics {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new WindPlantUserDefined().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(WindPlantUserDefined_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(WindPlantUserDefined_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated WindPlantUserDefined, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated WindPlantUserDefined, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            WindPlantUserDefined_primitive_builder attrEnum = WindPlantUserDefined_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindPlantUserDefined_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            WindPlantUserDefined_class_attributes_enum attrEnum = WindPlantUserDefined_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindPlantUserDefined_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : WindPlantUserDefined_primitive_builder.values()) {
            if (enumValue != WindPlantUserDefined_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindPlantUserDefined." + enumValue.name());
            }
        }
        for (var enumValue : WindPlantUserDefined_class_attributes_enum.values()) {
            if (enumValue != WindPlantUserDefined_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindPlantUserDefined." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "WindPlantUserDefined";
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindPlantUserDefined().allAttrNamespaceMap();
    }
