...
public class SvVoltage extends BaseClass {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new SvVoltage().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(SvVoltage_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(SvVoltage_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated SvVoltage, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated SvVoltage, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            SvVoltage_primitive_builder attrEnum = SvVoltage_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SvVoltage_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            SvVoltage_class_attributes_enum attrEnum = SvVoltage_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SvVoltage_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : SvVoltage_primitive_builder.values()) {
            if (enumValue != SvVoltage_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SvVoltage." + enumValue.name());
            }
        }
        for (var enumValue : SvVoltage_class_attributes_enum.values()) {
            if (enumValue != SvVoltage_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SvVoltage." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "SvVoltage";
    ...
    static {
        ATTR_NAMESPACE_MAP = new SvVoltage().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("TopologicalNode", "http://iec.ch/TC57/CIM100#"),
            Map.entry("angle", "http://iec.ch/TC57/CIM100#"),
            Map.entry("v", "http://iec.ch/TC57/CIM100#"),
