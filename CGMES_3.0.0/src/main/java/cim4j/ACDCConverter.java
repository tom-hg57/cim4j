...
public class ACDCConverter extends ConductingEquipment {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ACDCConverter().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("DCTerminals", "http://iec.ch/TC57/CIM100#"),
            Map.entry("PccTerminal", "http://iec.ch/TC57/CIM100#"),
            Map.entry("baseS", "http://iec.ch/TC57/CIM100#"),
            Map.entry("idc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("idleLoss", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maxP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("maxUdc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("minP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("minUdc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("numberOfValves", "http://iec.ch/TC57/CIM100#"),
            Map.entry("p", "http://iec.ch/TC57/CIM100#"),
            Map.entry("poleLossP", "http://iec.ch/TC57/CIM100#"),
            Map.entry("q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ratedUdc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("resistiveLoss", "http://iec.ch/TC57/CIM100#"),
            Map.entry("switchingLoss", "http://iec.ch/TC57/CIM100#"),
            Map.entry("targetPpcc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("targetUdc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("uc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("udc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("valveU0", "http://iec.ch/TC57/CIM100#"),
