...
public class PFVArControllerType1Dynamics extends DynamicsFunctionBlock {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new PFVArControllerType1Dynamics().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(PFVArControllerType1Dynamics_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(PFVArControllerType1Dynamics_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated PFVArControllerType1Dynamics, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated PFVArControllerType1Dynamics, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            PFVArControllerType1Dynamics_primitive_builder attrEnum = PFVArControllerType1Dynamics_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PFVArControllerType1Dynamics_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            PFVArControllerType1Dynamics_class_attributes_enum attrEnum = PFVArControllerType1Dynamics_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = PFVArControllerType1Dynamics_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : PFVArControllerType1Dynamics_primitive_builder.values()) {
            if (enumValue != PFVArControllerType1Dynamics_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PFVArControllerType1Dynamics." + enumValue.name());
            }
        }
        for (var enumValue : PFVArControllerType1Dynamics_class_attributes_enum.values()) {
            if (enumValue != PFVArControllerType1Dynamics_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "PFVArControllerType1Dynamics." + enumValue.name());
            }
        }
    ...
    static {
        ATTR_NAMESPACE_MAP = new PFVArControllerType1Dynamics().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            ...
            Map.entry("VoltageAdjusterDynamics", "http://iec.ch/TC57/CIM100#"),
