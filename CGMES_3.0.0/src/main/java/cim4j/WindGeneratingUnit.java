...
public class WindGeneratingUnit extends GeneratingUnit {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new WindGeneratingUnit().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(WindGeneratingUnit_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(WindGeneratingUnit_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated WindGeneratingUnit, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated WindGeneratingUnit, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            WindGeneratingUnit_primitive_builder attrEnum = WindGeneratingUnit_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindGeneratingUnit_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            WindGeneratingUnit_class_attributes_enum attrEnum = WindGeneratingUnit_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindGeneratingUnit_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : WindGeneratingUnit_primitive_builder.values()) {
            if (enumValue != WindGeneratingUnit_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindGeneratingUnit." + enumValue.name());
            }
        }
        for (var enumValue : WindGeneratingUnit_class_attributes_enum.values()) {
            if (enumValue != WindGeneratingUnit_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindGeneratingUnit." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "WindGeneratingUnit";
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindGeneratingUnit().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("WindPowerPlant", "http://iec.ch/TC57/CIM100-European#"),
            Map.entry("windGenUnitType", "http://iec.ch/TC57/CIM100#"),
