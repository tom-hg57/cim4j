...
public class RegulationSchedule extends SeasonDayTypeSchedule {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new RegulationSchedule().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(RegulationSchedule_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(RegulationSchedule_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated RegulationSchedule, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated RegulationSchedule, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            RegulationSchedule_primitive_builder attrEnum = RegulationSchedule_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = RegulationSchedule_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            RegulationSchedule_class_attributes_enum attrEnum = RegulationSchedule_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = RegulationSchedule_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : RegulationSchedule_primitive_builder.values()) {
            if (enumValue != RegulationSchedule_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "RegulationSchedule." + enumValue.name());
            }
        }
        for (var enumValue : RegulationSchedule_class_attributes_enum.values()) {
            if (enumValue != RegulationSchedule_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "RegulationSchedule." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "RegulationSchedule";
    ...
    static {
        ATTR_NAMESPACE_MAP = new RegulationSchedule().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("RegulatingControl", "http://iec.ch/TC57/CIM100#"),
