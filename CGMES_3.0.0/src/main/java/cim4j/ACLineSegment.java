...
public class ACLineSegment extends Conductor {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ACLineSegment().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("Clamp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("Cut", "http://iec.ch/TC57/CIM100#"),
            Map.entry("b0ch", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bch", "http://iec.ch/TC57/CIM100#"),
            Map.entry("g0ch", "http://iec.ch/TC57/CIM100#"),
            Map.entry("gch", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r0", "http://iec.ch/TC57/CIM100#"),
            Map.entry("shortCircuitEndTemperature", "http://iec.ch/TC57/CIM100#"),
