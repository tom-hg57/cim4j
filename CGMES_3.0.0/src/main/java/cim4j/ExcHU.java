...
public class ExcHU extends ExcitationSystemDynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new ExcHU().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("ae", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ai", "http://iec.ch/TC57/CIM100#"),
            Map.entry("atr", "http://iec.ch/TC57/CIM100#"),
            Map.entry("emax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("emin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("imax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("imin", "http://iec.ch/TC57/CIM100#"),
