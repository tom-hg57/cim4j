...
public class Quality61850 extends BaseClass {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("badReference", "http://iec.ch/TC57/CIM100#"),
            Map.entry("estimatorReplaced", "http://iec.ch/TC57/CIM100#"),
            Map.entry("failure", "http://iec.ch/TC57/CIM100#"),
            Map.entry("oldData", "http://iec.ch/TC57/CIM100#"),
            Map.entry("operatorBlocked", "http://iec.ch/TC57/CIM100#"),
            Map.entry("oscillatory", "http://iec.ch/TC57/CIM100#"),
            Map.entry("outOfRange", "http://iec.ch/TC57/CIM100#"),
            Map.entry("overFlow", "http://iec.ch/TC57/CIM100#"),
            Map.entry("source", "http://iec.ch/TC57/CIM100#"),
            Map.entry("suspect", "http://iec.ch/TC57/CIM100#"),
            Map.entry("test", "http://iec.ch/TC57/CIM100#"),
            Map.entry("validity", "http://iec.ch/TC57/CIM100#"),
