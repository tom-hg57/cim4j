...
public class LoadStatic extends IdentifiedObject {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("LoadAggregate", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ep1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ep2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ep3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eq1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eq2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("eq3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kp1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kp2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kp3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kp4", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kpf", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kq1", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kq2", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kq3", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kq4", "http://iec.ch/TC57/CIM100#"),
            Map.entry("kqf", "http://iec.ch/TC57/CIM100#"),
            Map.entry("staticLoadModelType", "http://iec.ch/TC57/CIM100#"),
