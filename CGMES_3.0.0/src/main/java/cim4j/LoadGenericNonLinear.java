...
public class LoadGenericNonLinear extends LoadDynamics {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("bs", "http://iec.ch/TC57/CIM100#"),
            Map.entry("bt", "http://iec.ch/TC57/CIM100#"),
            Map.entry("genericNonLinearLoadModelType", "http://iec.ch/TC57/CIM100#"),
            Map.entry("ls", "http://iec.ch/TC57/CIM100#"),
            Map.entry("lt", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tp", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tq", "http://iec.ch/TC57/CIM100#"),
