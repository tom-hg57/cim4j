...
public class SvShuntCompensatorSections extends BaseClass {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new SvShuntCompensatorSections().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(SvShuntCompensatorSections_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(SvShuntCompensatorSections_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated SvShuntCompensatorSections, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated SvShuntCompensatorSections, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            SvShuntCompensatorSections_primitive_builder attrEnum = SvShuntCompensatorSections_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SvShuntCompensatorSections_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            SvShuntCompensatorSections_class_attributes_enum attrEnum = SvShuntCompensatorSections_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = SvShuntCompensatorSections_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : SvShuntCompensatorSections_primitive_builder.values()) {
            if (enumValue != SvShuntCompensatorSections_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SvShuntCompensatorSections." + enumValue.name());
            }
        }
        for (var enumValue : SvShuntCompensatorSections_class_attributes_enum.values()) {
            if (enumValue != SvShuntCompensatorSections_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "SvShuntCompensatorSections." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "SvShuntCompensatorSections";
    ...
    static {
        ATTR_NAMESPACE_MAP = new SvShuntCompensatorSections().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("ShuntCompensator", "http://iec.ch/TC57/CIM100#"),
            Map.entry("sections", "http://iec.ch/TC57/CIM100#"),
