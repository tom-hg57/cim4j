...
public class PFVArType1IEEEPFController extends PFVArControllerType1Dynamics {
    ...
    static {
        ATTR_NAMESPACE_MAP = new PFVArType1IEEEPFController().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("ovex", "http://iec.ch/TC57/CIM100#"),
            Map.entry("tpfc", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vitmin", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vpf", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vpfcbw", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vpfref", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vvtmax", "http://iec.ch/TC57/CIM100#"),
            Map.entry("vvtmin", "http://iec.ch/TC57/CIM100#"),
