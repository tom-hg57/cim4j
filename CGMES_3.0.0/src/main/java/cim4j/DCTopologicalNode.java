...
public class DCTopologicalNode extends IdentifiedObject {
    ...
    static {
        ATTR_NAMESPACE_MAP = new DCTopologicalNode().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("DCEquipmentContainer", "http://iec.ch/TC57/CIM100#"),
            Map.entry("DCNodes", "http://iec.ch/TC57/CIM100#"),
            Map.entry("DCTerminals", "http://iec.ch/TC57/CIM100#"),
            Map.entry("DCTopologicalIsland", "http://iec.ch/TC57/CIM100#"),
