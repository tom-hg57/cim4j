...
public class HydroGeneratingUnit extends GeneratingUnit {
    ...
    private enum HydroGeneratingUnit_primitive_builder implements PrimitiveBuilder {
        ...
        turbineType() {
            public BaseClass construct(java.lang.String value) {
                return new HydroTurbineKind(value);
            }
        },
        LAST_ENUM() {
            public BaseClass construct(java.lang.String value) {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("HydroPowerPlant", "http://iec.ch/TC57/CIM100#"),
            Map.entry("dropHeight", "http://iec.ch/TC57/CIM100#"),
            Map.entry("energyConversionCapability", "http://iec.ch/TC57/CIM100#"),
            Map.entry("turbineType", "http://iec.ch/TC57/CIM100#"),
