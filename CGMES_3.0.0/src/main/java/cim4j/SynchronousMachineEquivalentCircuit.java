...
public class SynchronousMachineEquivalentCircuit extends SynchronousMachineDetailed {
    ...
    static {
        ATTR_NAMESPACE_MAP = new SynchronousMachineEquivalentCircuit().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("r1d", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r1q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("r2q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("rfd", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x1d", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x1q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("x2q", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xad", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xaq", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xf1d", "http://iec.ch/TC57/CIM100#"),
            Map.entry("xfd", "http://iec.ch/TC57/CIM100#"),
