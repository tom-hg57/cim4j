...
public class OverexcitationLimiterDynamics extends DynamicsFunctionBlock {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new OverexcitationLimiterDynamics().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(OverexcitationLimiterDynamics_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(OverexcitationLimiterDynamics_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated OverexcitationLimiterDynamics, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated OverexcitationLimiterDynamics, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            OverexcitationLimiterDynamics_primitive_builder attrEnum = OverexcitationLimiterDynamics_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = OverexcitationLimiterDynamics_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            OverexcitationLimiterDynamics_class_attributes_enum attrEnum = OverexcitationLimiterDynamics_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = OverexcitationLimiterDynamics_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : OverexcitationLimiterDynamics_primitive_builder.values()) {
            if (enumValue != OverexcitationLimiterDynamics_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "OverexcitationLimiterDynamics." + enumValue.name());
            }
        }
        for (var enumValue : OverexcitationLimiterDynamics_class_attributes_enum.values()) {
            if (enumValue != OverexcitationLimiterDynamics_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "OverexcitationLimiterDynamics." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "OverexcitationLimiterDynamics";
    ...
    static {
        ATTR_NAMESPACE_MAP = new OverexcitationLimiterDynamics().allAttrNamespaceMap();
    }
