...
public class NuclearGeneratingUnit extends GeneratingUnit {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new NuclearGeneratingUnit().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(NuclearGeneratingUnit_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(NuclearGeneratingUnit_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated NuclearGeneratingUnit, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated NuclearGeneratingUnit, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            NuclearGeneratingUnit_primitive_builder attrEnum = NuclearGeneratingUnit_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = NuclearGeneratingUnit_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            NuclearGeneratingUnit_class_attributes_enum attrEnum = NuclearGeneratingUnit_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = NuclearGeneratingUnit_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : NuclearGeneratingUnit_primitive_builder.values()) {
            if (enumValue != NuclearGeneratingUnit_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "NuclearGeneratingUnit." + enumValue.name());
            }
        }
        for (var enumValue : NuclearGeneratingUnit_class_attributes_enum.values()) {
            if (enumValue != NuclearGeneratingUnit_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "NuclearGeneratingUnit." + enumValue.name());
            }
        }
    ...
    static {
        ATTR_NAMESPACE_MAP = new NuclearGeneratingUnit().allAttrNamespaceMap();
    }
